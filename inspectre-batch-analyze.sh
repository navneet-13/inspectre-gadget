...
ADDRESS_LIST="/home/nosajmik/Desktop/inspectre-gadget/targets/libcap-ng.so.0.0.0.csv" # Path to the kernel addresses file
...
process_batch() {
  ...
  timeout "$timeout_duration" ./inspectre analyze /home/nosajmik/Desktop/inspectre-gadget/targets/libcap-ng.so.0.0.0 \
