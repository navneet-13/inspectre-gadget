...
ADDRESS_LIST="/home/nosajmik/Desktop/inspectre-gadget/targets/libssl.so.3.csv" # Path to the kernel addresses file
...
process_batch() {
  ...
  timeout "$timeout_duration" ./inspectre analyze /home/nosajmik/Desktop/inspectre-gadget/targets/libssl.so.3 \
