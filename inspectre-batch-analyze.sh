...
ADDRESS_LIST="/home/nosajmik/Desktop/inspectre-gadget/targets/ssh.csv" # Path to the kernel addresses file
...
process_batch() {
  ...
  timeout "$timeout_duration" ./inspectre analyze /home/nosajmik/Desktop/inspectre-gadget/targets/ssh \
